...
ExplicitFiniteDifference::ExplicitFiniteDifference(double S, double E, double T, double r
	, double d, double sigma, int NAS) : _S(S), _E(E), _T(T), _r(r), _d(d), _sigma(sigma), _NAS(NAS)
{
	_price = 0.0;
}
